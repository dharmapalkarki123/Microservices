...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props){
        ...
        CfnHealthCheck authDbHealthCheck=
                createDbHealthCheck(authServiceDb,"AuthServiceHealthCheck");
        CfnHealthCheck patientDbHealthCheck=
                createDbHealthCheck(patientServiceDb,"PatientServiceHealthCheck");
        ...
        FargateService authService =
                createFargateService("AuthService",
                        ...
                        List.of(4005),
                        authServiceDb,
                        Map.of("JWT_SECRET", "NjI3NjQwMjAxMDQ4MDIxNzMzNDg2NTI3MzIzODYwMTU="));
    ...
    private CfnCluster createMskCluster(){
        return CfnCluster.Builder.create(this,"MaskCluster")
    ...
    public static void main (final String[] args){
        ...
        System.out.println("App synthesizing in pogress...");
    }
